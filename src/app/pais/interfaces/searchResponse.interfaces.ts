...
//
//   const paisSearchResponse = Convert.toPaisSearchResponse(json);
//
...
export class Convert {
    public static toPaisSearchResponse(json: string): PaisSearchResponse[] {
        return cast(JSON.parse(json), a(r("PaisSearchResponse")));
    }

    public static paisSearchResponseToJson(value: PaisSearchResponse[]): string {
        return JSON.stringify(uncast(value, a(r("PaisSearchResponse"))), null, 2);
    }
}
